...
#     'Date' : 'first'
# }
# file = 'sqlite:///crypto_15m_from_2019.db'
# token_1 = 'ADA'
# candles = pd.read_sql(token_1, file).set_index('timestamp')
# data = candles.resample(interval,offset=None).agg(agg_dict)
# data = data[-500:-1]
# #data = pd.read_sql('ETH','sqlite:///prueba_df_dict.db').set_index('timestamp')

# settings = {
#     'time_range': ('10:00','11:30','17:00'),
#     'buffer': 0.00
# }


# data, _, _, _, _, _, _, _ = add_estrategia_time_breakout(data,settings)
# print(data.tail(80))
